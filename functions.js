...
function expireopt(req) {
	var disp = ['영구', '5분', '10분', '30분', '1시간', '2시간', '하루', '3일', '5일', '7일', '2주', '3주', '1개월', '3개월', '6개월', '1년'];
	var val  = [0, 300, 600, 1800, 3600, 7200, 86400, 259200, 432000, 604800, 1209600, 1814400, 2419200, 7257600, 15552000, 29030400];
